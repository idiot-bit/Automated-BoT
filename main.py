...
async def method2_send_to_channel(user_id, context):
    ...
    if len(posted_ids) >= 2:
        buttons.append([InlineKeyboardButton("✏️ 2-3apk With Caption", callback_data="auto_recaption")])
        buttons.append([InlineKeyboardButton("✏️ 2-3apk Last Caption", callback_data="auto_last_caption")])
        buttons.append([InlineKeyboardButton("✏️ 2-3apk Last Key", callback_data="last_caption_key")])
