...
def main():
    ...
    app.add_handler(CallbackQueryHandler(
        ...
        pattern=r"^(view_users|view_autosetup|viewsetup[1-4]|backup_config|force_reset|confirm_reset|settings_back|bot_admin_link|backup_restore|cancel_restore|confirm_restore|add_user|remove_user)$"
    ))
