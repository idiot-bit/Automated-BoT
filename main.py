...
owner_keyboard = ReplyKeyboardMarkup(
    keyboard=[
        [KeyboardButton("𝗨𝗦𝗘𝗥𝗦𝗧𝗔𝗧𝗦📊")],
        [KeyboardButton("𝗨𝗦𝗘𝗥𝗟𝗜𝗦𝗧👥"), KeyboardButton("𝗛𝗘𝗟𝗣❓")],
        [KeyboardButton("𝗣𝗜𝗡𝗚📶"), KeyboardButton("𝗥𝗨𝗟𝗘𝗦📜")],
        [KeyboardButton("𝗥𝗘𝗦𝗘𝗧♻️"), KeyboardButton("𝗦𝗘𝗧𝗧𝗜𝗡𝗚𝗦⚙️")],
        [KeyboardButton("𝗕𝗥𝗢𝗔𝗗𝗖𝗔𝗦𝗧📢")],
        [KeyboardButton("𝗢𝗡✅"), KeyboardButton("𝗢𝗙𝗙⛔")]
    ],
...
allowed_user_keyboard = ReplyKeyboardMarkup(
    keyboard=[
        [KeyboardButton("𝗠𝗘𝗧𝗛𝗢𝗗 𝟭⚡"), KeyboardButton("𝗠𝗘𝗧𝗛𝗢𝗗 𝟮🚀")],
        [KeyboardButton("𝗖𝗛𝗔𝗡𝗡𝗘𝗟📡")],
        [KeyboardButton("𝗖𝗔𝗣𝗧𝗜𝗢𝗡📝")],
        [KeyboardButton("𝗩𝗜𝗘𝗪𝗦𝗘𝗧𝗨𝗣📊")],
        [KeyboardButton("𝗛𝗘𝗟𝗣❓"), KeyboardButton("𝗥𝗘𝗦𝗘𝗧♻️")],
        [KeyboardButton("𝗣𝗜𝗡𝗚📶"), KeyboardButton("𝗥𝗨𝗟𝗘𝗦📜")]
    ],
    resize_keyboard=True,
    one_time_keyboard=False
...
async def handle_text(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        if message_text == "ping":
            ...
            return
        elif raw_message_text in ["𝗨𝗦𝗘𝗥𝗦𝗧𝗔𝗧𝗦📊", "userstats"] and user_id == OWNER_ID:
        ...
        # --- Handle ReplyKeyboard Method Selection ---
        if raw_message_text in ["𝗠𝗘𝗧𝗛𝗢𝗗 𝟭⚡", "𝗠𝗘𝗧𝗛𝗢𝗗 𝟮🚀"]:
            selected_method = "method1" if "𝟭" in raw_message_text else "method2"
            USER_STATE.setdefault(user_id, {})["current_method"] = selected_method
        
            await update.message.reply_text(
                f"✅ <b>{raw_message_text} Activated</b>\n"
                "Now send your APK file to continue.",
                parse_mode="HTML",
                reply_markup=allowed_user_keyboard
            )
            return
