...
async def handle_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # --- Back to Methods ---
        ...
        if user_id == OWNER_ID:
            # Owner sees Method 1, Method 2, Method 3
            keyboard = [
                [InlineKeyboardButton("⚡ Method 1", callback_data="method_1")],
                [InlineKeyboardButton("🚀 Method 2", callback_data="method_2")],
            ...
            # Normal user sees only Method 1 and 2
            keyboard = [
                [InlineKeyboardButton("⚡ Method 1", callback_data="method_1")],
                [InlineKeyboardButton("🚀 Method 2", callback_data="method_2")]
            ]
...
# Common InlineKeyboard after any toggle
def get_auto_keyboard(setup_num):
    ...
    elif data.startswith("resetsetup"):
        setup_num = data[-1]
