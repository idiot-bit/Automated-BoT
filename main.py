        ...
        if state and state.get("status") == "waiting_channel":
            ...
            if not (channel_id.startswith("@") or channel_id.startswith("-100")):
                await update.message.reply_text(
                    ...
                    "<i>Use format like:</i>\n"
                    "<code>@channelusername</code> or <code>-100xxxxxxxxxx</code>",
                    parse_mode="HTML"
                )
                return
            ...
            if member.status not in ["administrator", "creator"]:
                await update.message.reply_text(
                    ...
                    "<i>The bot is NOT an admin in this channel!</i>\n\n"
                    "<b>You must first:</b>\n"
                    "✅ Add bot to your channel\n"
                    "✅ Promote it as admin with full posting rights\n\n"
                    "<b>Until this is done, the bot will not function properly.</b>",
                    parse_mode="HTML"
                )
                return
            ...
            keyboard = [
                [InlineKeyboardButton("⚡ Method 1 — Single APK", callback_data="method_1")],
                [InlineKeyboardButton("🚀 Method 2 — Multi APK", callback_data="method_2")]
            ]
            ...
            await update.message.reply_text(
                ...
                "🛡️ <b>Bot Status:</b> <u><b>ADMIN CONFIRMED</b></u>\n"
                "🔄 <b>Channel Access:</b> Verified\n"
                "━━━━━━━━━━━━━━━━━━━━━\n"
                "<b>📌 Choose Your Posting Style</b>\n\n"
                "<b>⚡ METHOD 1</b> — <i>[ Simple | Quick | One APK ]</i>\n"
                " Post a single APK instantly.\n\n"
                "<b>🚀 METHOD 2</b> — <i>[ Batch | Custom Caption | Multi APK ]</i>\n"
                " Send up to 3 APKs with smart controls."
                "</blockquote>",
                parse_mode="HTML",
                reply_markup=InlineKeyboardMarkup(keyboard)
            )
