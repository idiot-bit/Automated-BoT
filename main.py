...
async def user_viewsetup(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        caption_raw = user_data.get("caption", "No caption set.")
        caption = html.escape(caption_raw)  # Escape HTML if user includes tags
        ...
        msg = (
            ...
            f"🗓️ <b>Active Since:</b> {int(days_active)} days\n"
