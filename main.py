...
async def backup_config(context=None):
    ...
    backup_filename = f"config_backup_{now}.json"
    ...
    # If context is available (called from a command), send file to owner
    if context:
        try:
...
async def handle_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "backup_config":
        ...
        await query.edit_message_text("✅ Backup created and sent to you!")
        return
