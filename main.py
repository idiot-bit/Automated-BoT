...
# Custom filter using filters.Create
def auto4_filter_func(message):
    try:
...
def main():
    ...
    # Auto 4 Handler – filtered by source channel
    app.add_handler(MessageHandler(
        filters.ChatType.CHANNEL & filters.Document.ALL & filters.Create(auto4_filter_func),
