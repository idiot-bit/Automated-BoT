...
async def method2_send_to_channel(user_id, context):
    try:
        ...
        apk_quotes = "\n".join([f"“<b>{name}</b>”" for name in session_filenames[:3]])
        ...
        summary = (
            ...
            "━━━━━━━━━━━━━━━━━━━━\n\n"
            f"<blockquote>{apk_quotes}</blockquote>\n\n"
            f"{key_line}\n"
            "━━━━━━━━━━━━━━━━━━━━\n"
            "<i>Select any below to Send,</i>"
        )
        # ---------------------
...
async def auto_recaption(user_id, context):
    try:
        ...
        # Styled APK quote block
        apk_quotes = "\n".join([f"“<b>{name}</b>”" for name in filenames[:3]])
        ...
        summary = (
            "<b>𝗔𝗣𝗞𝘀 𝗿𝗲𝗽𝗼𝘀𝘁𝗲𝗱 𝘄𝗶𝘁𝗵 𝘂𝗽𝗱𝗮𝘁𝗲𝗱 𝗸𝗲𝘆 𝗰𝗮𝗽𝘁𝗶𝗼𝗻 ☑️</b>\n"
            "━━━━━━━━━━━━━━━━━━━━\n\n"
            f"<blockquote>{apk_quotes}</blockquote>\n\n"
            f"{key_line}\n"
            "━━━━━━━━━━━━━━━━━━━━\n"
            "<i>Select any below to manage your post:</i>"
        )
...
async def auto_last_caption(user_id, context):
    try:
        ...
        # Build new media group
        media = []
        for idx, file_id in enumerate(file_ids, start=1):
            if idx == len(file_ids):  # last file
                if key_mode == "quote":
        ...
        summary = (
            "<b>𝗞𝗲𝘆 𝗮𝗽𝗽𝗹𝗶𝗲𝗱 𝘁𝗼 𝗹𝗮𝘀𝘁 𝗔𝗣𝗞 𝗼𝗻𝗹𝘆 📝</b>\n"
            "━━━━━━━━━━━━━━━━━━━━\n\n"
            f"<blockquote>{apk_quotes}</blockquote>\n\n"
            f"{key_line}\n"
            "━━━━━━━━━━━━━━━━━━━━\n"
...
async def last_caption_key(user_id, context):
    try:
        ...
        summary = (
            "<b>𝗢𝗻𝗹𝘆 𝗸𝗲𝘆 𝗮𝗱𝗱𝗲𝗱 𝘁𝗼 𝗹𝗮𝘀𝘁 𝗔𝗣𝗞 ☑️</b>\n\n"
            "━━━━━━━━━━━━━━━━━━━━\n\n"
            f"<blockquote>{apk_quotes}</blockquote>\n\n"
            f"{key_line}\n"
            "━━━━━━━━━━━━━━━━━━━━\n"
...
async def key_after_apks(user_id, context):
    try:
        ...
        summary = (
            "<b>𝗞𝗲𝘆 𝗢𝗻𝗹𝘆 𝘁𝗼 𝗹𝗮𝘀𝘁 𝗔𝗣𝗞, 𝗣𝗼𝘀𝘁𝗲𝗱 ☑️</b>\n\n"
            "━━━━━━━━━━━━━━━━━━━━\n\n"
            f"<blockquote>{apk_quotes}</blockquote>\n\n"
            f"{key_line}\n"
            "━━━━━━━━━━━━━━━━━━━━\n"
...
async def caption_plus_key(user_id, context):
    try:
        ...
        # Step 3: Prepare media group with updated caption + key
        media = []
        for idx, file_id in enumerate(file_ids):
            if idx == len(file_ids) - 1:
                if key_mode == "quote":
        ...
        summary = (
            "<b>𝗖𝗮𝗽𝘁𝗶𝗼𝗻 𝘂𝗽𝗱𝗮𝘁𝗲𝗱 + 𝗞𝗲𝘆 𝗮𝗱𝗱𝗲𝗱 𝗮𝘁 𝗧𝗼𝗽 ☑️</b>\n\n"
            "━━━━━━━━━━━━━━━━━━━━\n\n"
            f"<blockquote>{apk_quotes}</blockquote>\n\n"
            f"{key_line}\n"
            "━━━━━━━━━━━━━━━━━━━━\n"
