    ...
    try:
        ...
        if str(user_id) not in USER_DATA:
            USER_DATA[str(user_id)] = {
                ...
                "first_seen": int(time.time()),  # <- ADD THIS
            }
            save_config()
...
async def user_viewsetup(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        m1_apk = state.get("hourly_method1_apks", 0) + state.get("daily_method1_apks", 0)
        m2_apk = state.get("hourly_method2_apks", 0) + state.get("daily_method2_apks", 0)
        m1_key = state.get("hourly_method1_keys", 0) + state.get("daily_method1_keys", 0)
        m2_key = state.get("hourly_method2_keys", 0) + state.get("daily_method2_keys", 0)
        ...
        msg = (
            ...
            "━━━━━━━━━━━━━━━━━━━━━\n"
            "<b>🖋️ Saved Caption:</b>\n"
            f"<blockquote>{escape(caption)}</blockquote>\n"
            "━━━━━━━━━━━━━━━━━━━━━\n"
            "<b>📦 Method Stats:</b>\n"
